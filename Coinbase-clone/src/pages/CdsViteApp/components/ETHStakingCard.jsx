    ...
    <UpsellCard
      ...
      media={
        <Box left={16} position="relative" top={12}>
          <RemoteImage height={174} source="https://images.ctfassets.net/q5ulk4bp65r7/3iW5o8bA7qOIt4SikZ2rC4/3169fcbb0204ab3eb49da598b0492cb4/Earn_staking_rewards.png?w=1180&fm=png" />
        </Box>
      }
      title={
